...
public class ShrineChannelEventList {
	...
	public static List<Entity> listChanelEvents(String channel, String userName, Boolean ban, Boolean unlimitedSize) {
		...
		logger.info("{} , userName {}, ban {}, unlimitedSize {})", channel, userName, ban, unlimitedSize);
	...
	private static Query<Entity> buildQuery(String channel, String userName, Boolean ban, Boolean unlimitedSize) {
